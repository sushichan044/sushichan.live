...
最近ではもっぱらNext.jsで開発しているので、React Server Components(以下RSC)からSupabaseの認証機能にアクセス...
みたいなこともよくやるのですが、先日これでハマったので備忘録として書き残しておきます。
...
私も早めにこちらへ移行していたのですが、先日Twitterでソーシャルログインできるサービスを開発している時に
思わぬトラブルが起きました。
