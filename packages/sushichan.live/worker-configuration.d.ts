/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c3e8ae34fe067a8b36259aec3e9fa5a9)
// Runtime types generated with workerd@1.20250416.0 2025-04-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_CLOUDINARY_CLOUD_NAME: "sushichan044";
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_CLOUDINARY_CLOUD_NAME">> {}
}
