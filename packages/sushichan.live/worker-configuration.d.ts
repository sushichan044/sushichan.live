/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 38e32f05a7efbec1ac74d08ddb652210)
// Runtime types generated with workerd@1.20251217.0 2025-12-28 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CLOUDINARY_API_SECRET: string;
		PUBLIC_CLOUDINARY_API_KEY: string;
		PUBLIC_CLOUDINARY_CLOUD_NAME: string;
		SHOW_DRAFT_POST: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDINARY_API_SECRET" | "PUBLIC_CLOUDINARY_API_KEY" | "PUBLIC_CLOUDINARY_CLOUD_NAME" | "SHOW_DRAFT_POST">> {}
}
